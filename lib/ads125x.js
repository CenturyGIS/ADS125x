...
var ADS125x = exports.ADS125x = function () {
  ...
  function ADS125x(config) {
    ...
    // self.drdy = Promise.promisifyAll(self.drdy);
    ...
    // self.drdy.read((initError, initValue) => {
    //
    //   if (initError) {
  ...
  _createClass(ADS125x, [{
    ...
    value: function read(diffChannel) {
      ...
      // .then(received => received.receiveBuffer)
      .then(function (rb) {
