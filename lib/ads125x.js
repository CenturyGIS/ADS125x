...
var ADS125x = exports.ADS125x = function () {
  ...
  function ADS125x(config) {
    ...
    self.drdy = new _onoff.Gpio(config.drdyPin, 'in', 'falling');
  ...
  _createClass(ADS125x, [{
    ...
    value: function waitDRDY() {
      ...
      var drdyCallback = void 0;
      return new _bluebird2.default(function (resolve) {
        drdyCallback = function drdyCallback(err, value) {
          if (err) {
            console.error(err);
          }
        ...
        _this2.drdy.watch(drdyCallback);
      }).then(function () {
        return _this2.drdy.unwatch(drdyCallback);
      });
    }
  }]);
